...
led_setup_t leds_orange_teal[] = {
    { .hs = 0,  .he = 33,  .rs = 0,  .re = 0,  .gs = 255, .ge = 255, .bs = 170, .be = 170, .ef = EF_NONE },
    { .hs = 33, .he = 66,  .rs = 50,  .re = 200, .gs = 210, .ge = 80, .bs = 150, .be = 25, .ef = EF_NONE },
    { .hs = 66, .he = 100, .rs = 255, .re = 255, .gs = 69, .ge = 69, .bs = 0, .be = 0, .ef = EF_NONE },
    { .end = 1 },
};

led_setup_t leds_teal_read[] = {
    { .hs = 0,  .he = 33,  .rs = 0,  .re = 0,  .gs = 255, .ge = 255, .bs = 170, .be = 170, .ef = EF_NONE },
    { .hs = 33, .he = 66,  .rs = 50,  .re = 200, .gs = 210, .ge = 40, .bs = 150, .be = 25, .ef = EF_NONE },
    { .hs = 66, .he = 100, .rs = 255, .re = 255, .gs = 0, .ge = 0, .bs = 0, .be = 0, .ef = EF_NONE },
    { .end = 1 },
};
...
led_setup_t leds_orange[] = {
    { .hs = 0, .he = 100, .rs = 255, .re = 255, .gs = 127, .ge = 127, .bs = 0, .be = 0, .ef = EF_NONE },
    { .end = 1 },
};
...
//Vibranium
led_setup_t leds_vibranium[] = {
    { .hs = 0, .he = 100, .rs = 63, .re = 63, .gs = 0, .ge = 0, .bs = 255, .be = 255, .ef = EF_NONE },
    { .end = 1 },
};
